...
test('non-existing file', (t) => resolveSize('non-existing.gif')
  .then(t.fail, (err) => {
    t.true(err instanceof Error);
    t.is(err.message, 'Asset not found or unreadable: non-existing.gif');
  }));

test('nonsupported file type', (t) => resolveSize('test/fixtures/fonts/empty-sans.woff')
  .then(t.fail, (err) => {
...
test('invalid file', (t) => resolveSize('test/fixtures/invalid.jpg')
  .then(t.fail, (err) => {
